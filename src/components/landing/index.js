...
const Landing = props => {
  ...
  const scrollFunction = () => {
    ...
    if (firstPos !== '' && firstPos.top < 300 && firstPos.top > 0) setSection('1');
    if (secondPos !== '' && secondPos.top < 300 && secondPos.top > 0) setSection('2');
    if (thirdPos !== '' && thirdPos.top < 300 && thirdPos.top > 0) setSection('3');
